...
void UART3_Init(uint32_t baudrate)
{
	...
	SWM0->PINASSIGN.PINASSIGN11 = (9 << 24);			// TX3 = P0.9	RX3 = P0.28
	SWM0->PINASSIGN.PINASSIGN12 = (28 << 0);				// TX3 = P0.9	RX3 = P0.28
	...
	USART3->BRG = (FREQ_PRINCIPAL / baudrate) / 8;

	NVIC->ISER[0] = (1 << 30); /* enable interrupt */

	USART3->CFG |= 	(1);			// ENABLE USART1
}
...
int32_t UART3_PopRx( void )
{
	...
	{
		dato = (int32_t) UART3.TX.Buffer[UART3.RX.Indice_out];
		UART3.RX.Indice_out ++;
